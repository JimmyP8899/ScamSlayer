...
# Chatlog
chatlog = [
    {"role": "system", "content": "You are a chatbox designed to detect if an email is either Non-Malicious, suspicious, or malicious. Give it a confidence level from 1% to 100%."},
